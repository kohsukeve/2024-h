...
export const Header = () => {
 ...
 {/* ナビゲーション  Agency Price   */}
      <nav className="hidden gap-12 lg:flex">
        ...
        <a href="page3" className="text-lg font-semibold text-gray-600 transition duration-100 hover:text-indigo-500 active:text-indigo-700">Agency</a>
 ...
 {/* 問い合わせフォーム Toiawase*/  }
    ...
    <section className="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
      ...
      <div className="h-48 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:h-auto xl:w-5/12">
        ...
        <Image src='/item.jpg 'width={500} height={500} loading="lazy" alt="Photo by Item " className="h-full w-full object-cover object-center" />
      </div>
            {/* <!-- content - start --> */}
        ...
        <h1 className="mb-8 text-4xl font-bold text-black sm:text-5xl md:mb-12 md:text-6xl">代理店のことなら<strong>Valeur F</strong></h1>

        <p className="mb-8 leading-relaxed text-gray-500 md:mb-12 lg:w-4/5 xl:text-lg">メーカー様とお客様をつなぐ架け橋として、商品の販売促進やブランドイメージの向上に貢献しております。アパレルをもっと身近に、もっと楽しくするお手伝いをします。</p>

          <a href="mailto:sample@sample.com?subject=お問い合わせ"  className="inline-block rounded bg-indigo-500 px-20 py-2 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-800 focus-visible:ring active:bg-indigo-700 md:text-base">Join us</a>
